    ...
    public static void main(String[] args) {
        ...
        while (input != null) {
            switch (input) {
                ...
                case April:
                case May:
                    JOptionPane.showMessageDialog(null, "Happy Spring Break!");
                    System.exit(0);
                    break;
                case June:
                case July:
                case August:
                    JOptionPane.showMessageDialog(null, "Do you want to have a pool party?");
                    System.exit(0);
                    break;
                case September:
                case October:
                case November:
                    JOptionPane.showMessageDialog(null,"It's foliage season!");
                    System.exit(0);
                    break;
            }
